...
| ---------------------- | ----------------------------------------------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PagBank (API online)   | 2026-08-01                                                        | **✅ HOMOLOGAÇÃO FINALIZADA (2026-08-05)**     | Sandbox 8/8 (2026-08-03) + produção 8/8 com dinheiro real (2026-08-04) + e-mail oficial de encerramento do chamado 1424039934: _"apto para transacionar em produção"_. Nada pendente na API. Status Page para monitorar: status.pagbank.uol.com.br. **SmartPOS (PlugPag): RISCOS APROVADOS (2026-08-26, Geovanna Borges — Analista de Produtos, com Ingrid e Antonio em cópia)** — próximos passos confirmados: resposta "Android nativo" (enviada; WebView seria eliminatório, o nosso é Kotlin nativo por arquitetura) → **assinatura de contrato** → **envio dos terminais de debug** (fase-8-maquininha.md §8.1-J) |
...
| Cielo Smart (SmartPOS) | 2026-08-04 (e-mail ao suporte Integração Smart)                   | **❌ ELIMINADA — resposta oficial 2026-08-05** | Victor (Integração Smart): o `payment_code` existe, mas **"o processo de uma transação de pré-autorização na integração Smart ainda não está disponível"** — backlog em desenvolvimento, **sem previsão de conclusão**. Confirma a dissecação do APK (código no enum, fluxo ausente). E1 reprovado na prática. Contato de Lucas anotado por eles como referência de validação do futuro fluxo de pré-auth; reavaliar quando o tópico surgir em "Conteúdos complementares". Detalhes: fase-8-maquininha.md §8.1-F                                                                                                       |
